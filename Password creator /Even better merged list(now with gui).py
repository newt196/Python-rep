...
def main():
    ...
    # File 1 select
    tk.Label(root, text="Select File 1:").grid(row=0, column=0, padx=10, pady=10)
    ...
    # File 2 select
    tk.Label(root, text="Select File 2:").grid(row=1, column=0, padx=10, pady=10)
    ...
    # Merge
    merge_button = tk.Button(root, text="Merge Files", command=lambda: merge_files(file1_entry.get(), file2_entry.get(), output_entry.get()))
